...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/js/domElements.js":[function(require,module,exports) {
"use strict";
...
var domElements = function domElements() {
...
exports.API_URL = exports.KEY = void 0;
var KEY = 'NTUQthyeeVoGVGvfKbK40YIS5u8MthIk';
exports.KEY = KEY;
...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/js/gifModel.js":[function(require,module,exports) {
"use strict";
...
var constants = _interopRequireWildcard(require("./config.js"));
...
var Gifs = /*#__PURE__*/function () {
  ...
  _createClass(Gifs, [{
    key: "fetchQuery",
    value: function () {
      var _fetchQuery = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.default.mark(function _callee(query, offset) {
        var data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _axios.default.get("".concat(constants.API_URL, "search?api_key=").concat(constants.KEY, "&q=").concat(query, "&limit=50&offset=").concat(offset, "&rating=r&lang=en"));
...
},{"./config.js":"src/js/config.js","regenerator-runtime":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js"}],"src/js/viewController.js":[function(require,module,exports) {
"use strict";
...
var eraseImages = function eraseImages(parent, children) {
...
var view = _interopRequireWildcard(require("./viewController.js"));
...
var state = {
  imagesLoaded: 0,
  page: 0,
  gifs: new _gifModel.default(),
  dom: new _domElements.default()
}; //initialize app
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return state.gifs.fetchQuery('candy', state.page * 50);
...
init();
},{"./domElements.js":"src/js/domElements.js","./gifModel.js":"src/js/gifModel.js","./viewController.js":"src/js/viewController.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
